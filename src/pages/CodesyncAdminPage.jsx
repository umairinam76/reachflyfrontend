...
export default function CodesyncAdminPage() {
  ...
  async function deleteUser(row) {
    ...
    const confirmation = window.prompt(
      `Permanent action. Type ${row.email} to delete this user. Workspace ownership will be transferred automatically when possible; historical platform records are retained.`
    );
  ...
  return (
    <section className="cs-admin-panel cs-table-wrap">
      <div className="cs-admin-note">
        ...
        request. Any non-platform-owner user can be permanently deleted. If the
        deleted user owns a workspace, ReachFly transfers ownership to another
        active workspace user when possible; otherwise that workspace is suspended
        and preserved for later reassignment.
      </div>
      <table>
